...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try { await loadBootstrap(); if (actualUser) showApp(); else showLogin(); } catch (e) { console.error(e); showLogin(); alert('Nepodarilo sa načítať dáta zo servera.'); }
});